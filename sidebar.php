...
<input type="submit" name="submit" class="submitbutton" value="Submit" style="background-color: #109dce; color: white; font-weight: bold;">
  ...
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6" style="background-color: #f8f9fa;">
    ...
    <a href="https://luxsci.com/thank-you-best-practices-paper-high-email-deliverability/" target="_blank" class="block w-full text-white px-4 py-2 rounded transition-colors duration-200 text-sm font-bold text-center no-underline hover:opacity-90" style="background-color: #109dce;">Get Free Ebook</a>
  </div>
</div>